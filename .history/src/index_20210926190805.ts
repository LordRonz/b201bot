...
client.on('message', msg=>{
  ...
  } else if(msg.content == "Contoh Laporan Sebelum Praktikum") {
    msg.channel.send("https://drive.google.com/file/d/11MEQm5nxCET5EX2FfrS6u8fJXMJFRJ9g/view?usp=sharing")
  } else if(msg.content == "Contoh Laporan Lengkap") {
    msg.channel.send("https://drive.google.com/file/d/1xZOY3EolFyQUqXzQsmEtYRmW0GoJOmfu/view?usp=sharing")
  }
})
